...
(* OASIS_START *)
(* DO NOT EDIT (digest: 636f97ca6b07519bf2ce4c8cf2bc052a) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "voroMain.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\180\254(ZS\200\217ST\230\217\156\249\157\246p";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
